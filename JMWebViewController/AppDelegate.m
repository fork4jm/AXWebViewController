...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    /*
    NSBundle *bundle = [NSBundle bundleForClass:NSClassFromString(@"JMWebViewController")];
    NSString *bundlePath = [bundle pathForResource:@"JMWebViewController.bundle/html.bundle/404" ofType:@"html"];
     */
    /*
    JMWebViewController *webVC = [[JMWebViewController alloc] initWithAddress:@"https://www.baidu.com"];
    webVC.showsToolBar = NO;
    webVC.webView.allowsLinkPreview = YES;
    webVC.navigationType = JMWebViewControllerNavigationBarItem;
